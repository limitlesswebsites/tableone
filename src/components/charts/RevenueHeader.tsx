  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center mb-6">
      <div className="mb-4 md:mb-0">
        <h3 className="text-lg font-semibold text-white/80 mb-1 font-reemkufi uppercase" style={{ letterSpacing: '8px' }}>{metricInfo.title.toUpperCase()}</h3>
        <div className="text-3xl md:text-4xl font-bold font-reemkufi uppercase" style={{ color: metricInfo.color, letterSpacing: '8px' }}>
          <CountUp 
      ...
      <div>
        <div className="flex items-center bg-white/5 px-4 py-2 rounded-full">
          ...
          <span className="text-white/80 text-sm font-inter">+7.04% from previous month</span>
        </div>
      </div>
    </div>
  );
