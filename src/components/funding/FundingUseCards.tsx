...
const FundingUseCards: React.FC = () => {
  ...
  // Use a solid background color for mobile to avoid rendering issues
  const cardBackgroundClass = isMobile 
  ...
  return (
    <div className="text-center mb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className={`${cardBackgroundClass} rounded-xl p-6 hover:translate-y-[-5px] transition-all duration-500`}>
