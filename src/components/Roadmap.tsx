  ...
  return (
    <div className={`relative animate-fade-in animate-delay-${delay}`}>
      <div className={`absolute top-0 left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full ${
        isActive ? 'bg-gradient-to-r from-blue-500 to-purple-500' : 'bg-white/30'
      }`}></div>
      
      <div className="mt-8 glass-card p-6 max-w-xs mx-auto">
        <div className="font-medium text-sm text-white/60 mb-2">{quarter}</div>
  ...
  return (
    <section id="roadmap" className="py-24 relative">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute bottom-0 left-1/4 w-1/2 h-1/2 bg-blue-500/10 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="mt-24 text-center">
            <div className="glass-card p-8 inline-block animate-fade-in animate-delay-500">
